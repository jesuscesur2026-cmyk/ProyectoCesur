<p align="center">
  <img src="public/img/buho.svg" alt="Biblioteca para simples"/>
</p>

# Indice:
Biblioteca para simples
1. [¿Qué es Biblioteca para simples?](#1)
...
# ¿Qué es Biblioteca para simples?<a name="1"></a>

Biblioteca para simples es una biblioteca digital donde puedes encontrar miles de ejemplares de todas las temáticas con un simple click. 
...
El proyecto se desplegará en AWS mediante una instancia EC2 mientrás que la Base de Datos estará alojada en una RDS.
...
![Diagrama E/R](docs/TheOwl.drawio.svg)
...
- He añadido la función para que el usuario tenga que verificar su cuenta con un link que le llega a su cuenta de gmail para poder usar su cuenta en Biblioteca para simples
...
- Todo el css ha sido separado en modulos scss y luego mediante @import se han unido todos en un solo css llamado app.css
...
## Levantar con Docker (recomendado si hay problemas locales)

Se incluye una configuración mínima para desarrollar con Docker: `docker-compose.yml`, un `Dockerfile` para PHP-FPM y una configuración de Nginx. Para levantar los contenedores (necesitas Docker y Docker Compose instalados):
...
El `docker-compose` monta el proyecto en `/var/www/html` y expone el sitio en el puerto `8000`.


https://www.youtube.com/watch?v=nWEE_MAh6wo
