...
@section('titulo', $ejemplar->nomEjemplar)
...
@section('content')
    ...
    <div class="ejemplar">
        ...
        <div class="detalles detalles--grid">
            ...
            <div class="detalles__portada">
                ...
                <div class="puntuacion">
                    @for($i=1;$i<=5;$i++)
                        <a class="puntuacion__a" href="{{ route('ejemplar.puntuar', ['ejemplar' => $ejemplar, 'puntuacion' => $i]) }}">&#9733;</a>
                    @endfor

                    <p class="puntuacion__p">({{ $ejemplar->votos }})</p>
                    <p class="puntuacion__p--precio">{{ $ejemplar->precio }}€</p>
                    @if($ejemplar->votos > 0)
                        <span id="puntuacion" class="puntuacion__media">{{ round($ejemplar->puntuacion / $ejemplar->votos) }}</span>
                    @endif
                ...
                <div class="botones">
                    <a href="#" id="alquilar" class="libro__a">{{ __('Rent') }}</a>
                    <a href="{{ route('ejemplar.ejemplares') }}" class="libro__a">{{ __('Back') }}</a>
                </div>
            </div>
