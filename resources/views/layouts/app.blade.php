...
<body>
    <div class="logo">
        <a href="{{ route('inicio') }}"><img src="{{ asset('img/logo.png') }}" alt="logo"
        ...
        <div class="footer__contenido">
            ...
            <div class="footer__informacion footer__informacion--width">
                ...
                <p class="footer__p--justify">
                    {{ __('Biblioteca para simples is a library that contains a large number of books on many subjects for you to enjoy and learn from') }}
                </p>
            </div>
